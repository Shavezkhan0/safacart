...
export default function House_Appliances() {
    ...
    const categories = ["Refrigerator", "Washing_Machine", "Air_Conditioner", "Microwaves_Oven", "Fan"];
    ...
    const fetchProducts = async () => {
        ...
        setLoadingMore(true);
        try {
            const response = await fetch(`/api/products/getAll_CategoryProducts?skip=${products.length}&limit=10&${categoryQuery}`);
            ...
            console.error("Error fetching house appliance products:", error);
        } finally {
        ...
        <>
            ...
            <main>
                <section className="text-center py-20">
                    <h1 className="text-4xl pt-5 text-green-900 font-bold mb-4">Eco-Friendly House Appliances</h1>
                    ...
                    {loading ? (
                        ...
                        <div>
                            <h2 className="text-xl font-semibold mt-2">No House Appliances Found</h2>
