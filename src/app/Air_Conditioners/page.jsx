...
export default function Air_Conditioners() {
    ...
    const fetchProducts = async () => {
        ...
        setLoadingMore(true);
        try {
            const response = await fetch(`/api/products/getProducts_Category?category=Air_Conditioner&skip=${products.length}&limit=10`);
        ...
        <>
            ...
            <main>
                <section className="text-center py-20">
                    <h1 className="text-4xl pt-5 text-green-900 font-bold mb-4">Eco-Friendly Air_Conditioners</h1>
                    ...
                    {!hasMore && (
                        <p className="text-center mt-6 w-full col-span-full py-4 text-xl font-semibold text-gray-800 bg-green-100 rounded-xl shadow-lg mx-auto max-w-xs">
                            No More Air_Conditioners available
                        </p>
                    )}
                </section>
            </main>
