...
export default function Laptops() {
    ...
    const fetchProducts = async () => {
        ...
        setLoadingMore(true);
        try {
            const response = await fetch(`/api/products/getProducts_Category?category=Laptop&skip=${products.length}&limit=10`);
        ...
        <>
            ...
            <main>
                <section className="text-center py-20">
                    <h1 className="text-4xl pt-5 text-green-900 font-bold mb-4">Eco-Friendly Laptops</h1>
                    ...
                    {loading ? (
                        ...
                        <div>
                            <h2 className="text-xl font-semibold mt-2">No Laptops Found</h2>
