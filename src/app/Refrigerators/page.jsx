...
export default function Refrigerators() {
    ...
    const fetchProducts = async () => {
        ...
        setLoadingMore(true);
        try {
            const response = await fetch(`/api/products/getProducts_Category?category=Refrigerator&skip=${products.length}&limit=10`);
        ...
        <>
            ...
            <main>
                <section className="text-center py-20">
                    <h1 className="text-4xl pt-5 text-green-900 font-bold mb-4">Eco-Friendly Refrigerators</h1>
                    ...
                    {!hasMore && (
                        <p className="text-center mt-6 w-full col-span-full py-4 text-xl font-semibold text-gray-800 bg-green-100 rounded-xl shadow-lg mx-auto max-w-xs">
                            No More Refrigerators available
                        </p>
                    )}
                </section>
            </main>
