...
export default function Beds() {
    ...
    const fetchProducts = async () => {
        ...
        setLoadingMore(true);
        try {
            const response = await fetch(`/api/products/getProducts_Category?category=Bed&skip=${products.length}&limit=10`);
        ...
        <>
            ...
            <main>
                <section className="text-center py-20">
                    <h1 className="text-4xl pt-5 text-green-900 font-bold mb-4">Eco-Friendly Beds</h1>
