...
export default function Furniture() {
    ...
    const categories = ["Sofa", "Bed", "Chair", "Cabinet","Desk"];
        ...
        <>
            ...
            <main>
                <section className="text-center py-20">
                    <h1 className="text-4xl pt-5 text-green-900 font-bold mb-4">Eco-Friendly Furniture</h1>
                    ...
                    {loading ? (
                        ...
                        <div>
                            <h2 className="text-xl font-semibold mt-2">No Furniture Found</h2>
